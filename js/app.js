...
function moveFrog(position, points, startClass, endClass) {
...
// Movement
function objectMovement(object, start, end, interval, objectName, moveLeft, onObjectMove) {
 setInterval(() => {
...
objectMovement(log, 55, 65, 1000, 'log', true)
objectMovement(front, 43, 33, 1000, 'front', false)
objectMovement(middle, 43, 33, 1000, 'middle', false)
objectMovement(back, 43, 33, 1000, 'back', false)
objectMovement(turtle, 22, 32, 1000, 'turtle', true)
objectMovement(turtle2, 44, 54, 600, 'turtle', true)
